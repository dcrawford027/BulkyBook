    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count <= 1)
            {
                ...
                var count = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUser.Id == cart.ApplicationUserId).ToList().Count - 1;
        ...
        public IActionResult Remove(int cartId)
        {
            ...
            _unitOfWork.ShoppingCart.Remove(cart);
            _unitOfWork.Save();
            var count = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUser.Id == cart.ApplicationUserId).ToList().Count;
            HttpContext.Session.SetInt32(SD.SessionCart, count);
            return RedirectToAction(nameof(Index));
        }
